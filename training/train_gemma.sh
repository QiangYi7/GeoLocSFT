...
OUTPUT_DIR_ABS="$LLAMA_FACTORY_ROOT/saves/gemma-3-12b/lora_expanded/sft"
...
echo "模型: /home/ubuntu/gemma-3-12b-it"
echo "数据集: hfrl_data_expanded"
...
FORCE_TORCHRUN=1 llamafactory-cli train \
    ...
    --stage sft \
    --do_train \
    --model_name_or_path /home/ubuntu/gemma-3-12b-it \
    --dataset hfrl_data_expanded \
